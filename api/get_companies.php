  ...
  switch ($type)
  {
    case 1:
      ...
      if ($row = mysqli_fetch_array($result))
      {
        ...
        $json = "{\"i\":".jsonstrval($unv_cmp_id).",\"o\":".jsonstr(jsonnewline($unv_cmp_overview)).",\"b\":".jsonstr(jsonnewline($unv_cmp_benefit)).",\"p\":".jsonstr(jsonnewline($unv_cmp_process)).",\"phn\":".jsonstr($unv_cmp_phone).",\"eml\":".jsonstr($unv_cmp_email).",\"web\":".jsonstr($unv_cmp_web).",\"add\":".jsonstr($unv_cmp_address)."}";
      }
